<script type="text/javascript">
  window.location.href = '/semana-alta-produtividade'
</script>
...
<section class="flex-column flex-justify-center padding-tb-20">
  ...
  <form method="POST" action="https://officeagro.activehosted.com/proc.php" id="subscription" class="_form _form_1 _inline-form _dark" novalidate>
