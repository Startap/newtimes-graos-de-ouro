    ...
    <div id="video-container">
        <div class="youtube-video">
            <div class="youtube-iframe-container">
                <iframe class="youtube-iframe" width="988" height="556" src="https://www.youtube.com/embed/<?php echo $this->language['section_headline']['treinamento.youtube_video'] ?>" frameborder="0" allow="accelerometer; encrypted-media; gyroscope;" allowfullscreen>
                </iframe>
            </div>
        </div>
    </div>
