...
<div id="section-investiment" class="flex flex-column flex-justify-content-center flex-align-items-center">
    ...
    <div id="investiment-wrapper" class="flex flex-row flex-align-items-start">
        ...
        <div class="flex flex-column flex-justify-content-center flex-align-items-center" id="warranty-badge">
            <img loading="lazy" src="/assets/images/selo__garantia.png" alt="Selo de garantia incondicional de sete dias" title="Garantia incondicional de sete dias">
